...
export const INITIAL_COMPETITIONS: Competition[] = [
  {
    ...
    year: 2569,
    academic_year: '2569',
    competition_name: 'การแข่งขันกีฬากลุ่มโรงเรียนสังกัดสำนักงานเขตพื้นที่การศึกษาประถมศึกษาบุรีรัมย์ เขต 3',
    start_date: '2026-11-15',
    end_date: '2026-11-20',
    venue: 'สนามกีฬาโรงเรียนบ้านสว่าง และ สนามกีฬาโรงเรียนบ้านหนองหว้า',
    status: 'COMPETING',
    host_org: 'กลุ่มโรงเรียนสังกัดสำนักงานเขตพื้นที่การศึกษาประถมศึกษาบุรีรัมย์ เขต 3',
  ...
  },
  {
    ...
    year: 2568,
    academic_year: '2568',
    competition_name: 'การแข่งขันกีฬากลุ่มโรงเรียน ประจำปี 2568',
